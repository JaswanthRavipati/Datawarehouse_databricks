...
View the published Databricks dashboard
...
Ingest and preserve source data in Delta tables

Silver

Clean, validate, standardize, and prepare each dataset

Gold

Integrate the datasets into business-ready dimensions and facts

Dashboard

Convert the Gold data into interactive business insights
...
Open the EDA Sales Data dashboard
...
Create the required Bronze, Silver, and Gold schemas in Databricks.

Upload the CRM and ERP CSV source files to the configured Databricks volume locations.

Run Warehouse/Bronze_Layer/Bronze.ipynb.

Run Warehouse/Silver_Layer/Silver_orchestration.ipynb.

Run Warehouse/Gold_Layer/Gold_orchestration.ipynb.

Use Dashboard/Exploring Data.ipynb to inspect the completed warehouse.

Import or open the Lakeview dashboard to explore the sales KPIs and visualizations.
...
GitHub: JaswanthRavipati

Dashboard: EDA Sales Data
